      ...
      <Modal
        ...
        {!isSuccessSubmitSOS ? (
          <View style={[styles.modalContent, {backgroundColor: colors.bg}]}>
            ...
            <Text style={[styles.modalTitle, {color: colors.text}]}>SOS</Text>
            ...
            <View style={styles.inputContainer}>
              <Text style={[styles.label, {color: colors.info}]}>
                Pesan Darurat
              </Text>
              <TextInput
            ...
            <View style={styles.infoContainer}>
              ...
              <Text style={[styles.infoText, {color: colors.info}]}>
                Pesan Darurat akan terkirim ketika Anda memiliki koneksi
                internet.
              </Text>
            </View>
            ...
            <TouchableOpacity
              style={[
                ...
                !emergencyMessage.trim() && styles.disabledButton,
              ]}
              ...
              <Text
                style={[
                  ...
                  !emergencyMessage.trim() && styles.disableOutlineButtonText,
                ]}>
                {loading
                  ? 'Mengirim...'
                  : holding
                  ? `Tahan ${countdown} detik lagi`
                  : 'Tahan untuk Kirim SOS'}
              </Text>
            </TouchableOpacity>
          ...
          <View style={[styles.modalContent, {backgroundColor: colors.bg}]}>
            ...
            <Text style={[styles.modalSubtitle, {color: colors.info}]}>
              Pesan Darurat anda telah terkirim dan akan segera diproses oleh
              petugas kami. Selama dalam proses menunggu, pastikan anda dalam
              keadaan aman.
            </Text>
