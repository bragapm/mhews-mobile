  ...
  const steps = [
    {
      ...
      description:
        'Ketahui tingkat resiko bahaya di sekitar anda, dengan info lokasi evakuasi terdekat hingga informasi mitigasi bencana.',
    },
    {
      title: 'Peringatan Dini dan Informasi Jalur Evakuasi',
      description:
        'Dapatkan peringatan dini ketika terjadi bencana secara real-time, lengkap dengan petunjuk rute evakuasi untuk keselamatan anda.',
    },
    {
      title: 'Pantau Kondisi Kerabat Saat Terjadi Bencana',
      description:
        'Pantau dan pastikan kondisi orang terdekat anda ketika terjadi bencana, dengan melihat lokasi terkini dan kondisi disekitarnya.',
    },
  ];
