...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, PanResponder, Animated, Dimensions, Pressable, Image } from 'react-native';
...
const DisasterAlertScreen = () => {
    ...
    return (
        <View style={[styles.container, { backgroundColor: !isDanger ? "#F36A1D" : "#C4432C" }]}>
            <View style={styles.backgroundContainer}>
                <View style={styles.circleLarge}>
                    <View style={styles.circleSmall}>
                        <Image source={require("../assets/images/vector-danger.png")} style={styles.warningImage} />
                    </View>
                </View>
            </View>
            ...
            <View style={styles.header}>
                <Text style={styles.title}>{isDanger ? "Peringatan Tsunami" : "Peringatan Gempa!"}</Text>
                <Text style={styles.description}>
                    {isDanger ? "Jika anda menerima notifikasi ini, harap segera melakukan evakuasi ke zona aman dan mengiikuti petunjuk resmi" : "Jika anda menerima notifikasi ini, anda berada pada zona tidak aman. Harap mempersiapkan evakuasi dan ikuti petunjuk dari kami."}
                </Text>
            </View>
                        ...
                        <>
                            <View style={styles.cardLocation}>
                                <View style={styles.cardLokasi}>
                                    ...
                                    <Text style={styles.cardValue}>-7.72145772, 109.00724549</Text>
                                </View>
                                <TouchableOpacity style={styles.button}>
                                    <Text style={styles.buttonTextLokasi}>Peta Lokasi Bencana</Text>
                                </TouchableOpacity>
                            </View>
            ...
            <View
                ...
                {!isShowServices ? (
                    <>
                        {!isDanger ? (
                            <>
                                <TouchableOpacity style={styles.buttonPrimary} onPress={() => actionStatus("safe")}>
                                    <Text style={styles.buttonText}>Saya Tidak Terdampak</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.buttonSecondary} onPress={() => actionStatus("not_safe")}>
                                    <Text style={styles.buttonTextSecondary}>Saya Terdampak, Butuh Bantuan</Text>
                                </TouchableOpacity>
                            </>
                        ) : (
                            <TouchableOpacity style={styles.buttonDanger} onPress={() => actionStatus("not_safe")}>
                    ...
                    <>
                        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                            ...
                            <Pressable onPress={() => {
                                ...
                                <Feather name="x" size={24} color="#000" style={{ padding: 8, marginBottom: 20 }} />
                            </Pressable>
                        </View>
                        ...
                        <Pressable
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center" }}>
                                ...
                                <View style={{ flexDirection: "column", width: "90%" }}>
                                    <Text style={styles.methodTitle}>Nomor Kontak Center Bencana</Text>
                                    <Text style={styles.methodDesc}>
                                        Hubungi kontak center bencana untuk bantuan cepat dalam keadaan darurat
                                    </Text>
                                </View>
                                <Feather
                                    name="chevron-right"
                        ...
                        <Pressable
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center" }}>
                                ...
                                <View style={{ flexDirection: "column", width: "90%" }}>
                                    ...
                                    <Text style={styles.methodDesc}>
                                        Laporkan kejadian bencana atau situasi darurat yang anda alami
                                    </Text>
                                </View>
                                <Feather
                                    name="chevron-right"
