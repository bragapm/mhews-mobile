                            ...
                            {!showForm ? (
                                ...
                                >
                                    ...
                                    <View style={styles.infoContainer}>
                                        ...
                                        <Text style={styles.textValue}>{profile?.first_name} {profile?.last_name}</Text>
                                    </View>
                                    ...
                                    <TouchableOpacity style={styles.outlineButton} onPress={showFormEdit}>
                                ...
                                >
                                    <Text style={styles.subTitle}>
                                        Ubah Informasi Profil Pengguna yang anda inginkan. Pastikan informasi yang anda ubah seusai.
                                    </Text>
