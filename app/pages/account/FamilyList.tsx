                    ...
                    <>
                        <View style={styles.container}>
                            ...
                            <View style={styles.header}>
                                ...
                                <Text style={styles.title}>Daftar Kerabat</Text>
                            </View>
                                    ...
                                    <View style={styles.memberContainerDetailFamily}>
                                        <View style={styles.headerMemberDetail}>
                                            ...
                                            <View style={styles.memberInfo}>
                                                ...
                                                <Text style={styles.memberLocation}>Bandung, Jawa Barat</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={styles.memberContainerDetail}>
                                            ...
                                            <Text style={styles.memberLocation}>3202842211880004</Text>
                                        </View>
                                        <View style={styles.memberContainerDetail}>
