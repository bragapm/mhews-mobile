                            ...
                            <View style={styles.languageOptionContainer}>
                                <TouchableOpacity
                                    style={[
                                        ...
                                        selectedLanguage === 'indonesia' && styles.activeLanguageOption,
                                    ]}
                                ...
                                >
                                    ...
                                    <Text
                                        style={[
                                            styles.languageText,
                                            selectedLanguage === 'indonesia' && styles.activeLanguageText,
                                        ]}
                                    >
                                        Indonesia
                                        <br />
                                ...
                                <TouchableOpacity
                                    style={[
                                        styles.languageOption,
                                        selectedLanguage === 'english' && styles.activeLanguageOption,
                                    ]}
